...
💬 Conversational AI Assistant: A helpful chatbot, powered by Groq and GPT-OSS, ready to answer any questions about the application's features.
...
AI & Machine Learning: Groq LPU™ Inference Engine (GPT-OSS & Vision Engine)
